...
class DealershipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dealership" do
    assert_difference("Dealership.count") do
      post dealerships_url, params: { dealership: { address: @dealership.address, name: @dealership.name, phone: @dealership.phone } }
    end
  ...
  test "should update dealership" do
    patch dealership_url(@dealership), params: { dealership: { address: @dealership.address, name: @dealership.name, phone: @dealership.phone } }
